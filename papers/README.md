...
- **ML for SAT**: Shirokikh, Shenbin, Alekseev & Nikolenko, *Machine Learning for SAT: Restricted Heuristics and New Graph Representations* (2023). [arXiv:2307.09141](https://arxiv.org/abs/2307.09141) (the engineering tricks we evaluate here: Q-value warm-start, action pool, early release to VSIDS).
...
- **G4SATBench**: Li, Guo & Si, *Benchmarking and Advancing SAT Solving with Graph Neural Networks* (2023). [arXiv:2309.16941](https://arxiv.org/abs/2309.16941) (the PyTorch-Geometric benchmark and generalisation study).
- **SATformer**: Shi et al., *SATformer: Transformer-Based UNSAT Core Learning* (2022/2023). [arXiv:2209.00953](https://arxiv.org/abs/2209.00953) (a hierarchical Transformer over clause embeddings).
